  ...
  return (
    ...
    >
      <div
        style={{
          position: "relative",
          width: isHorizontal ? trackLength + nodeRadius * 2 : undefined,
          height: isHorizontal
            ? nodeRadius * 2 + 44
      ...
      >
        ...
        <svg
          style={{
            position: "absolute",
            left: isHorizontal ? nodeRadius : nodeRadius - 2,
            top: isHorizontal ? nodeRadius - 2 : nodeRadius,
            overflow: "visible",
            pointerEvents: "none",
          }}
          ...
          return (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                gap: 14,
                left: isHorizontal ? nodeRadius + i * segmentLength : 0,
                top: isHorizontal ? 0 : i * segmentLength,
                transform: isHorizontal ? "translateX(-50%)" : undefined,
                zIndex: 2,
              }}
            >
              <div
