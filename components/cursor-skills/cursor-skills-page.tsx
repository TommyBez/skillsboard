...
import type {
  CursorSkillsDefinition,
  CursorSkillsInlineLink,
} from "@/lib/seo/cursor-skills"
import { buildResourceArticleSchema } from "@/lib/seo/resource-article-schema"
import { resourcePaths } from "@/lib/seo/resources"
import { siteConfig } from "@/lib/site"

function InlineLink({ link }: { link: CursorSkillsInlineLink }) {
  return (
...
export function CursorSkillsPage({ entry }: { entry: CursorSkillsDefinition }) {
  return (
    <>
      ...
      <div className="mx-auto w-full max-w-[1000px] px-5 py-12 md:px-10 md:py-16">
        ...
        <header className="mt-8">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-3">
            <ResourceCta location="cursor_skills_hero" />
            <a
        ...
        <section aria-labelledby="locations-heading" className="pt-16">
          ...
          />
          <SectionTable
            caption="The directories Cursor scans for skills, and what each one is for."
        ...
        <section aria-labelledby="frontmatter-heading" className="pt-16">
          ...
          />
          <SectionTable
            caption="The SKILL.md frontmatter fields Cursor documents, and what each one controls."
        ...
        <section aria-labelledby="team-heading" className="pt-16">
          ...
          <div className="mt-8">
            <ResourceCta location="cursor_skills_inline" />
          </div>
          <SectionSources
        ...
        <section aria-labelledby="sources-heading" className="pt-16">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-relaxed text-muted-foreground">
            ...
            every claim about how Cursor handles skills comes from the
        ...
        <section className="mt-16 border-t border-border py-14 text-center md:py-16">
          ...
          <div className="mt-7 flex flex-wrap items-center justify-center gap-x-6 gap-y-3">
            <ResourceCta location="cursor_skills_closing" />
            <a
              href={siteConfig.githubUrl}
              target="_blank"
              rel="noreferrer"
