    ...
    >
      <div className="mx-auto w-full max-w-[1440px] px-5 pt-16 md:px-10 md:pt-20">
        <div className="mx-auto max-w-3xl rounded-[3px] border border-border bg-card p-6 text-left md:p-8">
          ...
          >
            Add Skills Board to Claude Code in two commands
          </h2>
          <p className="mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-base">
            The plugin carries the MCP connection and one skill that explains how
            to search a team library from an agent. Install it, then sign in
