                ...
                <div className="mt-5 grid gap-4">
                  {relatedResources.map((resource) => (
                    <Link
                      key={resource.path}
                      href={resource.path}
                      // See the note on the resources index: resolves the guide's
                      // slug before the click, so a related-guide navigation
                      // renders content instead of waiting on a server hop.
                      prefetch
