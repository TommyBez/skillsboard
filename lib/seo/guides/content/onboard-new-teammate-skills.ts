...
export const onboardNewTeammateSkillsGuide: GuideDefinition = {
  ...
  intro:
    "Onboarding a new teammate to AI skills should not begin with a catalog tour or a folder of setup notes. Give them one real task, one skill the team already uses, and enough context to choose a suitable path. The handoff works when they can find, inspect, and use the skill without private guidance.",
  answer:
    "Onboard a new teammate to AI skills with one real task and one reviewed skill, not a catalog tour. Give them the canonical source, a supported access path, the expected result, and clear safety boundaries. The handoff works when they can complete it without private guidance.",
  citations: {
  ...
  problem:
    "An invitation, copied command, or installed file proves access, not useful onboarding. The teammate still needs to know which problem the skill addresses, why the team keeps it, where its latest source lives, and what a good result looks like. A bounded handoff makes each of those decisions visible and tests whether the entry works without the original author filling in missing context.",
  decisionTitle: "Choose a handoff that ends in independent use",
  decisionIntro:
    "A useful handoff gives the teammate enough context to make a real choice without doing the task for them. Use one existing entry, one representative fixture, and one observable result instead of treating account access or installation as completion.",
  ...
  comparisonRows: [
    ...
    },
    {
      ...
      cells: [
        "One findable entry, its visible source, available use paths, and a real test task.",
  ...
  stepsIntro:
    "Assume the team library and at least one saved skill already exist. The new teammate should make the important discovery and usage decisions while an owner supplies the task, boundaries, and review criteria.",
  steps: [
    {
    ...
    {
      title: "Prepare one team entry",
      body: "Choose one skill the team already uses for that task. Confirm that its description, tags, original source, notes, and available use paths are current. Explain why it was selected without presenting the entry as a security review or compatibility guarantee.",
      output: "One complete, searchable entry tied to the first task.",
    },
    {
    ...
    },
    {
      ...
      output: "An independently found entry with the relevant source and limits identified.",
    },
    {
      title: "Let them choose a path and test the skill",
      body: "The teammate opens the original source, copies a compatible install command, or downloads the latest files as a ZIP. If their agent supports MCP, they can use it to find the same entry and retrieve the command. After setting up the skill outside Skills Board, they run the safe fixture and compare the result with the acceptance criteria.",
    ...
    },
    {
      ...
      body: "Capture the path and environment used, what the teammate could complete without help, and where the entry or setup was unclear. Keep, revise, or replace the entry, then name the owner and the source, agent, or workflow change that should trigger another review.",
  ...
  templateFields: [
    ...
    {
      label: "Team entry",
      value: "The skill, why the team keeps it, its search tags, source, and known limits.",
    },
    {
    ...
    },
    {
      ...
      value: "The task language used to search and whether the teammate found the entry without a private link.",
    },
    {
...
## 2. Team entry
- Skill: [name]
- Why the team keeps it: [specific task fit]
...
- Reminder: a saved skill is the team's own choice, not a security review or compatibility guarantee.
...
- Review again when: [source, agent, permissions, or workflow changes]`,
  ...
  pitfalls: [
    {
      ...
      body: "A long list shifts the work of choosing onto the newest person. Start with one real task and one skill the team can explain.",
    },
    {
    ...
    {
      title: "Treating a saved skill as approval",
  ...
  checklist: [
    ...
    "One team entry has current tags, notes, source, use paths, and known limits.",
    "The teammate has library access and understands the data, tool, and human review boundaries.",
    "The teammate found the entry by task or tag and inspected its original source.",
  ...
  sources: [
    {
      ...
      note: "Documents the team library, source visibility, available handoff paths, the limits of a saved entry, and optional MCP access implemented by Skills Board.",
    },
    {
      id: "openai-skills",
  ...
  og: {
    ...
    description:
      "A copyable checklist for finding, inspecting, testing, and improving one team skill handoff.",
