...
|---|---|---|---|
| Acquisition | Weekly scorecard plus protected pSEO research and one learning slot at least every seven days, independent of the routed stage and unrelated locks. The branch maintains at most 30 deduplicated seeds, five shortlisted opportunities, and four live pages without a completed 14-day checkpoint. | Research backlog update; one focused PR with at most two qualitative experimental pages from one problem cluster; when routed as the primary action, a bounded channel action or up to three sibling pages after quantitative or deployed-page evidence. | Missing demand data does not block the qualitative slot. Weak product fit, canonical overlap, thin content, inaccurate claims, an overlapping resource lock, four unvalidated live pages, another repository PR created in the same run, or failed SEO/verification blocks implementation. |
